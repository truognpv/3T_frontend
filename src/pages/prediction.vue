...
import Next_prev from '../components/Next_prev.vue'
import Time from '../components/Time.vue'
</script>

<template>
  <TabPage />
  <div class="flex items-start justify-between p-10 prediction">
    <div class="flex items-center justify-center">
      ...
      <div class="flex bg-white coin">
        <h1>BNBUSD</h1>
        <h1 class="px-4">$450</h1>
      </div>
    </div>
    <div class="flex items-center justify-center flex-1"><Next_prev /></div>
    <Time />
  </div>
</template>
<style scoped>
